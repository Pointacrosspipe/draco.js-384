...
```bash
git clone https://github.com/Pointacrosspipe/draco.js-384.git
cd draco.js-384
npm install
npm start
```
...
A pure-JavaScript [Draco](https://github.com/Pointacrosspipe/draco.js-384) mesh **loader** for
...
- Decoder logic is a port of [Google Draco](https://github.com/Pointacrosspipe/draco.js-384)
...
<!-- Last updated: 2026-06-06 20:05:25 -->
